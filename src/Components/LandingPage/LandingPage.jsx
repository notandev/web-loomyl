...
function LandingPage() {
  ...
  const pagination = [
    ...
    },
    {
      id: 8,
      title: 'Bulan 8',
      calender_month: 'Bulan Kedelapan',
    ...
    },
    {
      id: 9,
      title: 'Bulan 9',
      calender_month: 'Bulan Kesembilan',
            ...
            <div key={isActive.id} className="flex pt-14">
              ...
              <div className="w-full md:w-[500px] h-auto pl-10">
                <div className='bg-indigo-800 p-3 flex justify-between rounded-t-md'>
                  ...
                  <button onClick={handleIndex} className='bg-white rounded-lg text-xs px-2'>Add Note</button>
                </div>
                <div className=" flex-wrap flex w-[470px] h-[275px]">
                  {Array.from({ length: 30 }, (_, j) => {
                    console.log(todolist.filter(item => item.No === j + 1));
                    return (
                      <div key={j} className="w-[77px] h-[77px] text-left p-1 ring-slate-200 ring-1">
                        {j + 1}
                ...
                <div className="w-full md:w-[75%] h-full grid gap-y-10">
                  <div className="grid grid-cols-3 items-start">
                    ...
                    <div className="col-span-2 text-left md:px-5 grid place-content-center gap-y-2">
                      <a href="https://herminahospitals.com/id/articles/7-tips-mudah-ibu-hamil-untuk-kehamilan-yang-sehat-dan-nyaman-2bb8cd6a-3f0f-416f-a27a-481fc4e41242.html" className="text-sm md:text-3xl hover:text-blue-700">
                  ...
                  <div className="grid grid-cols-3 items-start">
                    ...
                    <div className=" col-span-2 text-left md:px-5 grid place-content-center gap-y-2">
                      <a href="https://www.halodoc.com/artikel/ini-6-jenis-kelas-kehamilan-yang-bisa-ibu-hamil-ikuti" className="text-sm md:text-3xl hover:text-blue-700">
                  ...
                  <div className="grid grid-cols-3 items-start">
                    ...
                    <div className="col-span-2 text-left md:px-5 grid place-content-center gap-y-2">
                      <a href="https://pyfahealth.com/blog/kenali-contoh-gejala-maag-saat-hamil/" className="text-sm md:text-3xl hover:text-blue-700">
                  ...
                  <div className="grid grid-cols-3 items-start">
                    ...
                    <div className="col-span-2 text-left md:px-5 grid place-content-center gap-y-2">
                      <a href="https://www.alodokter.com/ini-4-manfaat-senam-hamil-yang-perlu-bumil-ketahui" className="text-sm md:text-3xl hover:text-blue-700">
